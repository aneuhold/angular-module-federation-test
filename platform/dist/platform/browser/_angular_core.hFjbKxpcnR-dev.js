...
function detachViewFromDOM(tView, lView) {
  lView[ENVIRONMENT].changeDetectionScheduler?.notify(10
...
function extractEffectsFromInjector(injector) {
  ...
  return effects.map(effect2 => effect2[SIGNAL$1]);
}
...
function ɵɵdeferPrefetchOnIdle() {
  ...
  if (!shouldAttachTrigger(1, lView, tNode)) return;
  scheduleDelayedPrefetching(onIdle, 0
  /* DeferBlockTrigger.Idle */);
}
...
function ɵɵdeferPrefetchOnTimer(delay) {
  ...
  if (!shouldAttachTrigger(1, lView, tNode)) return;
  scheduleDelayedPrefetching(onTimer(delay), 5
...
var BASE_EFFECT_NODE = /* @__PURE__ */(() => __spreadProps(__spreadValues({}, REACTIVE_NODE$1), {
  consumerIsAlwaysLive: true,
...
function createRootEffect(fn, scheduler, notifier) {
  ...
  node.notifier.notify(13
  /* NotificationSource.RootEffect */);
  return node;
}
var NOT_SET = Symbol("NOT_SET");
var EMPTY_CLEANUP_SET = /* @__PURE__ */new Set();
var AFTER_RENDER_PHASE_EFFECT_NODE = /* @__PURE__ */(() => __spreadProps(__spreadValues({}, SIGNAL_NODE$1), {
  consumerIsAlwaysLive: true,
  consumerAllowSignalWrites: true,
  value: NOT_SET,
  cleanup: null,
