...
import { Injectable, InjectionToken, inject, Optional, Inject, ɵɵinject as ɵɵinject2, ɵfindLocaleData, ɵLocaleDataIndex, ɵgetLocaleCurrencyCode, ɵgetLocalePluralCase, LOCALE_ID, ɵregisterLocaleData, ɵstringify, Directive, Input, createNgModule, NgModuleRef, ɵRuntimeError, Host, Attribute, RendererStyleFlags2, untracked, ɵisPromise, ɵisSubscribable, Pipe, DEFAULT_CURRENCY_CODE, NgModule, Version, ɵɵdefineInjectable as ɵɵdefineInjectable2, ɵformatRuntimeError, PLATFORM_ID, ɵIMAGE_CONFIG, Renderer2 as Renderer22, ElementRef as ElementRef2, Injector, DestroyRef, ɵperformanceMarkFeature, NgZone, ApplicationRef, ChangeDetectorRef as ChangeDetectorRef2, numberAttribute, booleanAttribute, ɵIMAGE_CONFIG_DEFAULTS, ɵunwrapSafeValue } from "@angular/core";
...
var NgOptimizedImage = class _NgOptimizedImage {
  ...
  renderer = inject(Renderer22);
  imgElement = inject(ElementRef2).nativeElement;
...
function postInitInputChangeError(dir, inputName) {
  ...
  return new ɵRuntimeError(2953, `${imgDirectiveDetails(dir.ngSrc)} \`${inputName}\` was updated after initialization. The NgOptimizedImage directive will not react to this input change. ${reason} To fix this, either switch \`${inputName}\` to a static value or wrap the image element in an @if that is gated on the necessary value.`);
}
