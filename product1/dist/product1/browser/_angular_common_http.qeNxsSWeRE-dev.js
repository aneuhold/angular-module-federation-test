  ...
  constructor(options = {}) {
    ...
    if (options.fromString) {
      if (options.fromObject) {
        throw new ɵRuntimeError(2805, ngDevMode && "Cannot specify both fromString and fromObject.");
      }
  ...
  request(first, url, options = {}) {
    ...
    switch (options.observe || "body") {
          ...
          case "arraybuffer":
            return res$.pipe(map(res => {
              if (res.body !== null && !(res.body instanceof ArrayBuffer)) {
                throw new ɵRuntimeError(2806, ngDevMode && "Response is not an ArrayBuffer.");
              }
              return res.body;
            }));
          case "blob":
            return res$.pipe(map(res => {
              if (res.body !== null && !(res.body instanceof Blob)) {
                throw new ɵRuntimeError(2807, ngDevMode && "Response is not a Blob.");
              }
              return res.body;
            }));
          case "text":
            return res$.pipe(map(res => {
              if (res.body !== null && typeof res.body !== "string") {
                throw new ɵRuntimeError(2808, ngDevMode && "Response is not a string.");
              }
              return res.body;
            }));
          case "json":
      ...
      case "response":
        return res$;
      default:
        throw new ɵRuntimeError(2809, ngDevMode && `Unreachable: unhandled observe type ${options.observe}}`);
    }
  }
  /**
